...
{
    public class SerializeTopic : Topic
    {

        public ColorTopicMessage topicMessage;

        private static SerializeTopic m_Instance;

        public static SerializeTopic Instance { get { return m_Instance; } }
        ...
        public SerializeTopic(GameObject gameObj) : base(gameObj)
        {
