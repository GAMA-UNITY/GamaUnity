...
namespace ummisco.gama.unity.Scene
{
	public class SceneManager : MonoBehaviour
	{
		...
		/// <summary>
		/// Set GameObject attributes values in MonoBehaviour components. If an attribute exists in several MonoBehaviour components
		/// then its value will be updated on of them.
		/// </summary>
