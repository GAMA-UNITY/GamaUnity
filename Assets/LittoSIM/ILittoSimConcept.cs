...
namespace ummisco.gama.unity.littosim
{
    public class ILittoSimConcept
    {
        ...
        // Tag names
        public const string LAND_USE_TAG = "Land_Use";
        public const string COASTAL_DEFENSE_TAG = "Coastal_Defense";
        public const string DISTRICT_TAG = "District";
        public const string PROTECTED_AREA_TAG = "Protected_Area";
